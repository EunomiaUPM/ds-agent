...
/// and then handed to the service layer. Helps for RBAC
#[derive(Debug, Clone)]
pub struct AccessScope {
    acting_tenant: String,
    unrestricted: bool, // for admins
}
...
impl AccessScope {
    ...
    pub fn for_read(claims: &Claims, tenant: &String) -> Outcome<Self> {
    ...
    #[allow(clippy::result_large_err)]
    pub fn for_write(claims: &Claims, tenant: &String) -> Outcome<Self> {
    ...
    pub fn from_role(role: RbacRole, tenant: &String) -> Self {
        Self {
            acting_tenant: tenant.clone(),
            unrestricted: role == RbacRole::Admin,
        }
    }
    ...
    pub fn permits(&self, owner: &String) -> bool {
