...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260515_000002_transfer_messages"
    }
}
...
impl MigrationTrait for Migration {
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(
                        ColumnDef::new(TransferMessages::Id)
                            .string()
                            .not_null()
                            .primary_key(),
                    )
                    .col(
                        ColumnDef::new(TransferMessages::TransferProcessId)
                            .string()
                            .not_null(),
                    )
                    .col(
                    ...
                    .col(
                        ColumnDef::new(TransferMessages::Protocol)
                            .string()
                            .not_null(),
                    )
                    .col(
    ...
    async fn down(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager
            .drop_table(Table::drop().table(TransferMessages::Table).to_owned())
            .await
    }
}
