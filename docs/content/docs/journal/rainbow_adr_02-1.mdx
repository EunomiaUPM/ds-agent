...
5. **API Exposure:** Create the secured endpoints for creating instances and listing templates. Integrate with the existing `authority` system for request authentication.
