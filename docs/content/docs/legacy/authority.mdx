---
title: "Eunomia DS-Agent Identity System"
---
...
This document provides the documentation to understand the authentication system developed for Eunomia DS-Agent.

## Consumer

Interacts with the rest of the "consumer" services, as defined by Carlos.
...
- **Dependencies**
  ```bash
  /crates/auth/ssi-auth/consumer/... # Root
  /crates/auth/ssi-auth/common/...   # Common auth modules dependencies
  /crates/db/auth_consumer/...       # DB dependencies
  /crates/common/...                 # Project-wide common dependencies
  ```
- **Swagger**  
...
Interacts with the rest of the "provider" services, as defined by Carlos.
...
- **Dependencies**
  ```bash
  /crates/auth/ssi-auth/provider/... # Root
  /crates/auth/ssi-auth/common/...   # Common auth modules dependencies
  /crates/db/auth_provider/...       # DB dependencies
  /crates/common/...                 # Project-wide common dependencies
  ```
- **Swagger**  
