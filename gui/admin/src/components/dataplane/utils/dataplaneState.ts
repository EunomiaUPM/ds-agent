...
export function dataplaneStateVariant(state?: string | null): BadgeState {
  switch (state?.toLowerCase()) {
    case "init":          return "REQUESTED";
    case "configuring":   return "ACTIVE";
    case "auth":          return "ACCEPTED";
    case "ready":         return "AGREED";
    case "subscribing":   return "STARTED";
    case "started":       return "STARTED";
    case "unsubscribing": return "SUSPENDED";
