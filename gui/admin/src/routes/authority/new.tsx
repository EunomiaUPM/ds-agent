                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            >
                              <FormControl>
                                <SelectTrigger>
                                  <SelectValue placeholder={discoveredInfo ? "Select VC type" : "Discover first..."} />
                                </SelectTrigger>
                              </FormControl>
                              <SelectContent>
          ...
          <div className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Details retrieved from the authority.
                </CardDescription>
              </CardHeader>
                ...
                {discoveredInfo ? (
                  <div className="space-y-4">
                    <div className="space-y-1">
                      <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">Authority DID</p>
                      <Badge variant="infoLighter" className="font-mono text-[10px] break-all p-2">
                        {discoveredInfo.id}
                      </Badge>
                    </div>
                    <div className="space-y-1">
                      <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">Available VC Types</p>
