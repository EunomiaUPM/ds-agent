...
import { Shield, Clock, CheckCircle2, AlertCircle, Info, ExternalLink, Copy, Check, Loader2, Key } from "lucide-react";
import { z } from "zod";
...
function RequestDetailsPage() {
      ...
      <PageLayout>
        ...
        <PageSection>
          <div className="flex justify-center py-20">
            <Badge variant="infoLighter" className="animate-pulse">Loading details...</Badge>
          </div>
        </PageSection>
      </PageLayout>
    );
  ...
  return (
    <PageLayout>
      <PageHeader 
        title={`Request: ${request.authority_slug || 'Authority'}`} 
      >
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-6 gap-x-4">
                ...
                <DetailItem label="Authority DID">
                  <span className="font-mono text-xs break-all">{formatUrn(request.authority_id || '')}</span>
                </DetailItem>
                <DetailItem label="Authority Slug">
