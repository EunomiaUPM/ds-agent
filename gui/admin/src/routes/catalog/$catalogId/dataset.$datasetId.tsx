...
function RouteComponent() {
    ...
    console.log(catalog, "catalog in dataset details route")
        ...
        <PageLayout>
            <div className="grid grid-cols-3 gap-12 max-h-[85vh]">
                <div className="rounded-md border border-background-200/60 bg-background-200/5 p-4 ">
                    <Heading level="h2">{dataset.dctTitle} Dataset</Heading>
                                    ...
                                    content: (
                                        <div className="bg-background-200/15  border rounded-md border-white/5 flex flex-col p-3 gap-1">
                                            <Link to="/catalog/$catalogId" params={{ catalogId: catalogId }}>
                                                <Heading level="h5" className='capitalize !mb-0 underline-offset-2 hover:underline'> {catalog?.dctTitle || "My catalog"} </Heading>
                                            </Link>
                                            <p className="text-xs text-muted-foreground">  This is the catalog of <span className='capitalize'>{myAgentSlug}</span></p>
                                        </div>
                                    )
                                }
                            }
