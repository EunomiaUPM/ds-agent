        ...
        <PageLayout>
            <div className="grid grid-cols-3 gap-12 max-h-[85vh]">
                                ...
                                value: {
                                    ...
                                    content: (
                                        <div className="bg-background-200/15  border rounded-md border-white/5 flex flex-col p-3 gap-1">
                                            <Link to="/catalog/participant/$participantId" params={{ participantId: participantId }}>
                                                <Heading level="h5" className='capitalize !mb-0 underline-offset-2 hover:underline'> {otherParticipantSlug}'s Catalog for Demo</Heading>
                                            </Link>
                                            <p className="text-xs text-muted-foreground">  This is the catalog of <span className='capitalize'>{otherParticipantSlug}</span></p>
                                        </div>
                                    )
                                }
                            }
                ...
                <div className="container-policies-distributions max-h-[85vh] overflow-y-scroll pr-4 col-span-2">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                           {currentDataset?.distribution && currentDataset?.distribution.map((d: any) => (
                            <DistributionItem
                                key={d["@id"]}
