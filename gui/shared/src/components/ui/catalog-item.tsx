  ...
  return (
    <div>
        ...
        <div className="catalog-text-container">
          <Heading level="h3" className="mb-1">Catalog title</Heading>
          <p>Descripción del catálogo pues sería una frase corta que dice de qué va el contenido del catálogo.</p>
        </div>
