...
///
/// Symmetric to [`ConsumerRequestStep`]: advances the process state and records
/// a new offer alongside the state transition message.
pub(super) struct ProviderOfferStep;

#[async_trait::async_trait]
impl NegotiationProtocolStep for ProviderOfferStep {
