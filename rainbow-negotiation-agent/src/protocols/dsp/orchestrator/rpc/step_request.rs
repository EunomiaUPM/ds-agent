...
///
/// Advances the process state and records a new offer alongside the message.
pub(super) struct RpcRequestStep;

#[async_trait::async_trait]
impl NegotiationRpcStep for RpcRequestStep {
    ...
    async fn send_and_persist(
        ...
        let peer_url =
            format!("{}/negotiations/{}/request", ctx.peer_address, ctx.peer_identifier);
